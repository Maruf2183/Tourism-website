...
const Signin = () => {
    ...
    return (
        ...
        <div className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center form-left" >
            <div className="absolute bg-black opacity-60 inset-0 z-0"></div>
            <div className="w-full px-24 z-10">
                <h1 className="text-5xl font-bold text-left tracking-wide">Just connect with us</h1>
                <p className="text-3xl my-4"> It is our responsibility to show you paradise</p>
            </div>
        ...
        <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0 from-right">
            <div className="absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center mobile-view">
                <div className="absolute bg-black opacity-60 inset-0 z-0"></div>
            </div>
